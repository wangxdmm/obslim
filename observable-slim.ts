...
export type SlimArray = any[] & {
  __slim_length: number;
  __slim_arrOpPending: boolean;
};
...
const _create = function (target, domDelay, originalObservable?, originalPath?) {
  ...
  var handler = {
    get: function (target, property) {
      ...
      if (isSlimArray(target) && ["push", "pop", "unshift", "shift", "splice"].indexOf(property) > -1) {
